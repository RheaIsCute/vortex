...
- **Optional Vortex Telemetry**: A background-only Overwolf companion for the player's own live K/D/A and headshot-kill rate. It has no in-game window and does not require Valorant Tracker; see [its setup guide](overwolf/vortex-telemetry/README.md).
